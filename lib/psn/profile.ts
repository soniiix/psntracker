 ...
 *
 * @param psnId 
 * @returns The profile information for the specified PSN ID. This includes the online ID, account ID, avatar URL, PS Plus status, about me section, and trophy summary. If the profile cannot be retrieved, an error is thrown with details about the failure.
 */
